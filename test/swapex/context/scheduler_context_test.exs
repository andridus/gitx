defmodule Swapex.Context.SchedulerContextTest do
  use Swapex.DataCase, async: false
  use Oban.Testing, engine: Oban.Engines.Lite, queues: [github: 1, webhook: 10], repo: Swapex.Repo
